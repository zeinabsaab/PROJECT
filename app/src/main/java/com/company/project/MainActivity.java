...
//firestore
        ...
        EditText e=(EditText)findViewById(R.id.edit_txt_source);
        ...
        mdocref.set(datasave).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(MainActivity.this,"yes yes",Toast.LENGTH_LONG).show();
            }

        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(MainActivity.this,"no no ",Toast.LENGTH_LONG).show();
            }
        });
